    ...
    def __init__(self, d_model, num_heads):
        ...
        self.register_buffer(
            ...
            torch.tensor(np.array([
                [0, 3, 2, 2, 1, 2, 3, 4, 4, 4, 3, 2, 1, 4],
                [3, 0, 3, 1, 2, 4, 5, 1, 1, 1, 2, 2, 3, 6],
                [2, 3, 0, 2, 1, 3, 4, 4, 4, 4, 3, 2, 2, 5],
                [2, 1, 2, 0, 1, 3, 4, 2, 2, 2, 1, 1, 2, 5],
                [1, 2, 1, 1, 0, 2, 3, 3, 3, 3, 2, 1, 1, 4],
                [2, 4, 3, 3, 2, 0, 1, 5, 5, 5, 4, 3, 1, 2],
                [3, 5, 4, 4, 3, 1, 0, 6, 6, 6, 5, 4, 2, 1],
                [4, 1, 4, 2, 3, 5, 6, 0, 1, 1, 3, 3, 4, 7],
                [4, 1, 4, 2, 3, 5, 6, 1, 0, 1, 3, 3, 4, 7],
                [4, 1, 4, 2, 3, 5, 6, 1, 1, 0, 3, 3, 4, 7],
                [3, 2, 3, 1, 2, 4, 5, 3, 3, 3, 0, 2, 3, 6],
                [2, 2, 2, 1, 1, 3, 4, 3, 3, 3, 2, 0, 2, 5],
                [1, 3, 2, 2, 1, 1, 2, 4, 4, 4, 3, 2, 0, 3],
                [4, 6, 5, 5, 4, 2, 1, 7, 7, 7, 6, 5, 3, 0]
            ])).float()
        )
